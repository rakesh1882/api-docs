...
<Callout>
  <strong>Note:</strong> The recommended way to navigate from code is to instead add <a href="https://www.framer.com/legacy/api/property-controls/#event-handler">an EventHandler property control</a> to a code component.
</Callout>
...
[Animation](/legacy/api/animation/) options that set the transition properties for the animation.
