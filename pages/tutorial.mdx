<!-- 👋 Editing this file? Need help? → https://github.com/framer/legacy/api-docs/blob/master/CONTRIBUTING.md -->
...
<Button
  ...
  link="https://misc.framerstatic.com/legacy/api/tutorial-start.framerx"
/>
...
export function App() {
  return (
    ...
    >
      <Frame
        center
        image={"https://misc.framerstatic.com/legacy/api/logo.jpg"}
        radius={4}
      />
    </Frame>
  )
...
>
  <Frame
    ...
    center
    size={480}
    image={"https://misc.framerstatic.com/legacy/api/bg.jpg"}
  />
  <Slider />
</Frame>
```
...
<Button
  ...
  link="https://misc.framerstatic.com/legacy/api/tutorial-complete.framerx"
/>
</div>
<div>
...
- [**Framer:** Drag Properties & Events](/legacy/api/frame/#drag)
- [**Framer:** MotionValue](</legacy/api/animation/#(motionvalue:class)>)
- [**Framer:** useMotionValue()](/legacy/api/animation/#usemotionvalue)
- [**Framer:** useTransform()](/legacy/api/animation/#usetransform)
...
If you’d like to see some more examples on animation, gestures, dragging, paging, scrolling and more [visit our examples](/legacy/api/examples/) section for detailed explanations and code samples.
